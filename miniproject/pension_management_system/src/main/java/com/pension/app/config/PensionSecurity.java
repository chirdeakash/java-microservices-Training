...
public class PensionSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.httpBasic().and().authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/Approve/pension").hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/Get/issuePension").hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/Get/loadPension").hasAnyRole("ADMIN").and().csrf().disable().headers()
