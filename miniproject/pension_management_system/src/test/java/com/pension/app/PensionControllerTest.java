...
class PensionControllerTest {
    ...
    @MockBean private PensionService pensionService;
    @MockBean private PensionRepository pensionRepository;

    @Test @WithMockUser(roles = "USER") void testCheckBalance() throws Exception{
